...
<div class="container my-3">
    <div class="row mb-2">
        <div class="col-12">
            <h2 class="text-center my-3 text-negro"> NOVEDADES </h2>
        </div>
        @foreach ($productos as $producto)
        @if ($producto->tipo === "Acción")
        <div class="col-md-3 col-6">
            <div class="card card-cascade card-ecommerce wider shadow mb-5 ">
                ...
                <div class="card-body card-body-cascade text-center">
                    <!--Card Title-->
                    <h4 class="card-title"><strong><a href="">{{ $producto->nombre }}</a></strong></h4> <!-- Card Description-->
