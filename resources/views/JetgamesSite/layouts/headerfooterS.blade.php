...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light mb-0 bg-whitesmoke">
            <div class="container-fluid bg-whitesmoke mb-0 ">
                <a href="{{route('index')}}" class="text-decoration-none" title="Link to INDEX">
                    <img src="{{asset('img/logo.png')}}" title="logo Jetgames" alt="logo Jetgames" class="img-fluid ms-2"
                        style="width: 9em; border-image: 2px;">
                </a>
                ...
                <div class="collapse navbar-collapse mb-0" id="navbarSupportedContent">
                    ...
                    <li>
                        <div class="dropdown mx-4">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuUser">
                                ...
                                <li class="dropdown-item">
                                    <a class="nav-link mx-3" href="{{ route('main-page') }}" title="Link to INDEX">
                                       Area <br> Administrativa <i class="fas fa-briefcase"></i>
                                    </a>
                                </li>
                                @endif
                                <li>
                        ...
                        <li class="nav-item">
                            <a href="#">
                                <img src="{{asset('IMG/shopping-cart-line.svg')}}" alt="carrito-compras" id="car">
                                <label for="car" class="me-2 text-dark">Carrito</label>
                            </a>
                        </li>
                        @else
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-purple mt-0">
                ...
                <div class="collapse navbar-collapse mt-0" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link  text-white" href="{{ route('listjuegos_pc') }}" id="navbarDropdown" role="button">
                                Computadora
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('listjuegos_one') }}">Xbox One</a></li>
                                <li><a class="dropdown-item" href="{{ route('listjuegos_360') }}">Xbox 360</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('listjuegos_ps4') }}">Play Station 4</a></li>
                                <li><a class="dropdown-item" href="{{ route('listjuegos_ps3') }}">Play Station 3</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{ route('listjuegos_switch') }}">Nintendo Switch</a></li>
                                <li><a class="dropdown-item" href="{{ route('listjuegos_wii') }}">Nintendo Wii</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    @if(Auth::check())
    <img class="img-fluid" src="{{asset('IMG/PS BOARD.jpg')}}" id="banner">
    @endif
    <!-- BODY -->
        ...
        <div class="container-fluid">
            <div class="row bg-purple">
                <div class="col-md-3 col-6 mt-3">
                    ...
                    <img src="IMG/tarjetas.png" width="200px" class="img-fluid mb-2 ms-sm-5">
                </div>
                <div class="col-md-3 col-6 mt-3">
                    <h3>ENLACES DE INTERES</h3>
                    <p class="ms-sm-4"><a href="Nosotros.html">Nosotros</a><br><a href="Aviso.html">Aviso de
                            privacidad</a><br>
                        <a href="Condicion.html">Condiciones de uso</a></p>
                </div>
                <div class="col-md-3 col-6 mt-3">
                    <h3>SIGUENOS EN</h3>
                    <a class="text-light display-6 px-4 text-dark ms-sm-4" href="#" target="_blank"
                        alt="icono instagram" title="Link to Instsgram"><i class="fab fa-instagram text-white"></i></a>
                    <a class="text-light display-6 px-4 text-dark" href="#" target="_blank" alt="icono twitter"
                        title="Link to Twitter"><i class="fab fa-twitter text-white"></i></a>
                    <a class="text-light display-6 px-4 text-dark" href="#" target="_blank" alt="icono facebook"
